          ...
          <>
            {dragOffset > 0 && (
              ...
              <div className="absolute left-8 top-1/2 -translate-y-1/2 z-50 pointer-events-none">
                <div
                  className={`flex items-center justify-center w-16 h-16 rounded-full bg-black/70 backdrop-blur-sm border border-white/30 transition-all duration-200 ${
                    Math.abs(dragOffset) > 100
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col md:flex-row">
                ...
                {/* Text / meta column */}
                <div className="relative flex-1 px-6 sm:px-10 flex items-end md:items-center pb-8 md:pb-0">
                  <div
                    className={`max-w-xl transition duration-700 ${
                      active
                  ...
                  >
                    {item.spotlight && (
                      <div className="text-sm font-medium mb-4 text-white/70 tracking-wide uppercase">
                        {item.spotlight}
                      </div>
                    )}
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-[12px] text-white/70 mb-5">
                      ...
                      {item.quality && (
                        <span className="badge badge-blue pl-1.5 pr-2 py-0.5 text-[11px]">
                          {item.quality}
                        </span>
                      )}
                    ...
                    {item.description && (
                      <p className="text-sm text-white/70 leading-relaxed line-clamp-4 mb-8 max-w-xl">
                        {item.description}
                      </p>
                    )}
                ...
                <div className="hidden md:block relative w-full md:w-[62%] lg:w-[60%] h-60 md:h-full mt-6 md:mt-0 pointer-events-none">
                  <Image
                    src={item.thumbnail || "/vercel.svg"}
                    alt={item.title || "Anime poster"}
                    fill
                  ...
                  <div className="pointer-events-none absolute inset-y-0 -left-2 w-[420px] lg:w-[470px] bg-[linear-gradient(to_left,rgba(0,0,0,0)_0%,rgba(0,0,0,0.4)_30%,rgba(0,0,0,0.78)_58%,rgba(0,0,0,0.94)_78%,#000_92%)]" />
                  {/* Strong top vignette */}
                  <div className="pointer-events-none absolute inset-x-0 top-0 h-48 bg-[linear-gradient(to_bottom,#000,rgba(0,0,0,0.92)_22%,rgba(0,0,0,0.65)_55%,rgba(0,0,0,0)_90%)]" />
                  {/* Strong bottom vignette */}
                  <div className="pointer-events-none absolute inset-x-0 bottom-0 h-56 bg-[linear-gradient(to_top,#000,rgba(0,0,0,0.94)_30%,rgba(0,0,0,0.7)_65%,rgba(0,0,0,0)_95%)]" />
                </div>
              </div>
            </div>
          );
